...
This repository contains an up-to-date list of all Claude Code's various system prompts and their associated token counts as of **[Claude Code v2.1.34](https://www.npmjs.com/package/@anthropic-ai/claude-code/v/2.1.34) (February 5th, 2026).**  It also contains a [**CHANGELOG.md**](./CHANGELOG.md) for the system prompts across 91 versions since v2.0.14.  From the team behind [<img src="https://github.com/Piebald-AI/piebald/raw/main/assets/logo.svg" width="15"> **Piebald.**](https://piebald.ai/)
...
- [System Prompt: Skillify Current Session](./system-prompts/system-prompt-skillify-current-session.md) (**1750** tks) - System prompt for converting the current session in to a skill..
...
- [System Reminder: Plan mode is active (5-phase)](./system-prompts/system-reminder-plan-mode-is-active-5-phase.md) (**1429** tks) - Enhanced plan mode system reminder with parallel exploration and multi-agent planning.
